...
";
		...
		private static readonly IList<string> ExcludedStrings = new[] { ".resx", ".tt" };

		private static readonly XamlConverter Converter = new XamlConverter();
		...
		public static Project WithDocuments(this Project project)
		{
			...
			project =
				compiles
					...
					.Where(x => !ExcludedStrings.Any(s => x.EndsWith(s, StringComparison.InvariantCultureIgnoreCase)))
