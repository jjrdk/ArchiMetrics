...
namespace ArchiCop.VisualStudioData
{
    internal static class VisualStudioProjectRepositoryExtensions
    {
        ...
        public static IEnumerable<VisualStudioProjectProjectReference> GetProjectReferences(this XDocument document,
                                                                                            string fileName)
        {
            ...
            foreach (XElement reference in references)
            {
                ...
                visualStudioProject.Project =
                    reference.Element(NameSpace + "Project").Value.TrimStart('{').TrimEnd('}').ToLower();
                ...
                visualStudioProject.ProjectPath =
                    Path.GetFullPath((new Uri(visualStudioProject.ProjectPath)).LocalPath).ToLower();
