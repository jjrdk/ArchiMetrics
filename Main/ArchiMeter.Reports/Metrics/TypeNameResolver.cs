namespace ArchiMeter.Reports.Metrics
{
	...
	internal sealed class TypeNameResolver
	{
		...
		{
			NamedTypeSymbol symbol2 = symbol as NamedTypeSymbol;
			if (symbol2 == null)
			{
				return null;
			}
		...
		{
			TypeDeclarationSyntax syntax2 = syntax as TypeDeclarationSyntax;
			if (syntax2 == null)
			{
				return null;
			}
		...
		public static string GetName(TypeDeclarationSyntax syntax)
		{
			...
			if (syntax.TypeParameterList != null)
			{
				...
				if (parameters.Any())
				{
					string str3 = string.Join(", ", parameters.Select(x => x.Identifier.ValueText));
		...
		public static string GetQualifiedName(TypeSymbol symbol)
		{
			...
			NamedTypeSymbol symbol2 = (NamedTypeSymbol)symbol;
			...
			{
				NamespaceSymbol symbol4 = (NamespaceSymbol)symbol3;
